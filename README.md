...
*   **Changable game lengths?** Choose between going for 1, 2, or 3 minutes or until someone reaches 5, 10, or 15 points

## Installation

*   To play you must have a Linux computer to download the re-compiled executable and run it.

## How exactly to do this

1. *Download* Get the executable from the itch.io page (LINK!!!!!!!)

2. *Navigate* Open your terminal and navigate to a directory to open it in
...
There is a way to do this with something hopefully related to source launch.
